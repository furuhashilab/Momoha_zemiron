...
3)	今回の防災用ピクトグラムを、カラーユニバーサルデザインにするかを検討した。カラーユニバーサルデザインのポイントは3点あり、1つが出来るだけ多くの人に見分けやすい配色を選ぶ。2つ目が、色を見分けにくい人にも情報が伝わるようにする。3つ目が、色の名前を用いたコミュニケーションを可能にする。ということが挙げられる。よく、ピクトグラムに使われる赤は、黒やこげ茶と混同しやすく、オレンジや赤橙色を使うことが求められる。また、オレンジや赤橙色を使う上で、背景を白色にしたり、白の縁取りをすると目立つ。このように、一つの色を使うのにも様々な工夫が必要である。このことから、デザインだけでなく色彩にも意識をした。また、色覚障害がある方にとって、枠線を囲むだけ絵も違うようなので、色だけでなく枠線の囲みなどにも意識をした。しかし、色覚障害者の方々にとって、黒色なら、色の識別が付きやすくていいと思うが、
筑波大学の工藤真央さんと山本早里さんによると、知的障害者の方に、トイレのピクトグラムを見せたところ、色付きのピクトグラムがJISのピクトグラムよりも認識しやすいということが分かった。これは、男女が青と赤で表されるという概念があるからかもしれないが、色付きのピクトグラムの方が知的障碍者の方にとって、認識しやすいということがわかった。したがって、今回、デザインするうえで、カラーユニバーサルデザインを検討した。   
![](https://user-images.githubusercontent.com/49857316/73446147-9b255e80-439f-11ea-9c40-a5fcef6a5341.JPG)

3点デザインしたうえで、注意した点は、上述した3点の論点を踏まえ、色覚障害者でも健常者と同じ色として見える、黒、茶色、灰色の3色のみを使うことで、カラーユニバーサルデザインにしたこと。そして、多くの人が簡単にまねして書けるデザインを意識した。
一つ目は、具体的に、食料であるパンと、コーヒーカップを書くことで、食料を調達できる場所ということがわかるようにした。。2つ目は、鍋とお玉で、配給のイメージだと大きな鍋にお玉というイメージが強い。しかし、このピクトグラムの問題点として、配給というより、何か調理をする場所というようにとらえられてしまう可能性がある。
そして、3つ目は、スプーンとフォーク。世界全体をみて、橋を使う人より、スプーンとフォークを食事の際に使う人が多いため、スプーンとフォークを書いた。   

![ピクトグラム２](https://user-images.githubusercontent.com/49857316/73451915-0c6b0e80-43ac-11ea-9159-452c97d1bc8f.jpg)   
![ピクトグラム３](https://user-images.githubusercontent.com/49857316/73452988-6ff63b80-43ae-11ea-85b0-548d63d05941.jpg)   
![ピクトグラム4](https://user-images.githubusercontent.com/49857316/73453075-974d0880-43ae-11ea-8f36-0bea11330aa8.jpg)
